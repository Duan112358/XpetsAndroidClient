...
import com.emacs.pulltorefresh.PullToRefreshBase.OnPullEventListener;
import com.emacs.pulltorefresh.PullToRefreshBase.OnRefreshListener;
import com.emacs.pulltorefresh.PullToRefreshBase.OnRefreshListener2;
import com.emacs.pulltorefresh.PullToRefreshBase.State;
...
public interface IPullToRefresh<T extends View> {
	 ...
	 * ScrollView , etc) is in a state where a Pull-to-Refresh could occur by
	 * a user's touch gesture(scroll to the top/bottom)
	 * 
